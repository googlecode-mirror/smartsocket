<?php
Class MUConsole implements Template{
	protected $s;
	
	public function MUConsole() {
		...
		if(@file_exists("Extensions/MUConsole/Config.xml")) {
			$this->Config = simplexml_load_file("Extensions/MUConsole/Config.xml");
		}else {
