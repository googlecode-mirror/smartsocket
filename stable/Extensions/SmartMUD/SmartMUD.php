<?php
Class SmartMUD implements Template{
	protected $s;
	
	public function SmartMUD() {
		...
		if(@file_exists("Extensions/SmartMUD/Config.xml")) {
			$this->Config = simplexml_load_file("Extensions/SmartMUD/Config.xml");
		}else {
